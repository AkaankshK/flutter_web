...
class ToyotaServiceReportHeader extends StatelessWidget {
  @override
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(child: Align(
              ...
              child: Text("Vehicle History Report",style: TextStyle(fontWeight: FontWeight.w700,fontSize: height/22),))),
          Expanded(child: Align(
